...
public class DataBaseQuery {
    ...
    private int randomListSizeCity() {
        ...
        List<String> listSize = namedParameterJdbcTemplate.query(sqlFindAllCity,
    ...
    public String getRandomCity() {
        ...
        List<String> city = namedParameterJdbcTemplate.query(sqlFindCity,
                (rs, i) -> rs.getString("name"));
    ...
    public Float getPriceForHour(String city) {
        ...
        List<String> price = namedParameterJdbcTemplate.query(sqlFindPrice, map,
    ...
    public Integer getScheduleId(Integer executorUserId) {
        ...
        List<Integer> scheduleId = namedParameterJdbcTemplate.query(sqlFindLastScheduleId,
                map, (rs, i) -> rs.getInt("id"));
    ...
    public int howManyCountRegions(){
        ...
        return namedParameterJdbcTemplate.query(sqlFindCountRegions,
                (rs, i) -> rs.getInt("id")).size();
    }
    ...
    public String clientAddress(int clientId, int index){
        ...
        List<String> s = namedParameterJdbcTemplate.query(sqlSelectAddress,map,
                (rs,i)->rs.getString("address"));
        return s.get(index);
    }
